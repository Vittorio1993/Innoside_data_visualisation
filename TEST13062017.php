...
?>
    ...
    <div id="main" style="width:800px;height:500px;background-image:url(arg_mairie_plan_13062017.jpg);background-repeat:no-repeat"></div>
        ...
        require(
            ...
            function (ec) {
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                 ...
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray10x[i]/2.3+300),
                        (250-jsarray10y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray11x[i]/2.3+300),
                        (250-jsarray11y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray12x[i]/2.3+300),
                        (250-jsarray12y[i]/2.2),
                        0.1
                    ]);
                } 
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray13x[i]/2.3+300),
                        (250-jsarray13y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray14x[i]/2.3+300),
                        (250-jsarray14y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray15x[i]/2.3+300),
                        (250-jsarray15y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray16x[i]/2.3+300),
                        (250-jsarray16y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray17x[i]/2.3+300),
                        (250-jsarray17y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray18x[i]/2.3+300),
                        (250-jsarray18y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray19x[i]/2.3+300),
                        (250-jsarray19y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray20x[i]/2.3+300),
                        (250-jsarray20y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray21x[i]/2.3+300),
                        (250-jsarray20y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray22x[i]/2.3+300),
                        (250-jsarray22y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray23x[i]/2.3+300),
                        (250-jsarray23y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray24x[i]/2.3+300),
                        (250-jsarray24y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray25x[i]/2.3+300),
                        (250-jsarray25y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray26x[i]/2.3+300),
                        (250-jsarray26y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray27x[i]/2.3+300),
                        (250-jsarray27y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray28x[i]/2.3+300),
                        (250-jsarray28y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray29x[i]/2.3+300),
                        (250-jsarray29y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray30x[i]/2.3+300),
                        (250-jsarray30y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray31x[i]/2.3+300),
                        (250-jsarray31y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray32x[i]/2.3+300),
                        (250-jsarray32y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray33x[i]/2.3+300),
                        (250-jsarray33y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray34x[i]/2.3+300),
                        (250-jsarray34y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray35x[i]/2.3+300),
                        (250-jsarray35y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray36x[i]/2.3+300),
                        (250-jsarray36y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray37x[i]/2.3+300),
                        (250-jsarray37y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray38x[i]/2.3+300),
                        (250-jsarray38y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray39x[i]/2.3+300),
                        (250-jsarray39y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray40x[i]/2.3+300),
                        (250-jsarray40y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray41x[i]/2.3+300),
                        (250-jsarray41y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray42x[i]/2.3+300),
                        (250-jsarray42y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray43x[i]/2.3+300),
                        (250-jsarray43y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray44x[i]/2.3+300),
                        (250-jsarray44y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray45x[i]/2.3+300),
                        (250-jsarray45y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray46x[i]/2.3+300),
                        (250-jsarray46y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray47x[i]/2.3+300),
                        (250-jsarray47y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray48x[i]/2.3+300),
                        (250-jsarray48y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray49x[i]/2.3+300),
                        (250-jsarray49y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray50x[i]/2.3+300),
                        (250-jsarray50y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray51x[i]/2.3+300),
                        (250-jsarray51y[i]/2.2),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray52x[i]/2.3+300),
                        (250-jsarray52y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray53x[i]/2.3+300),
                        (250-jsarray53y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray54x[i]/2.3+300),
                        (250-jsarray54y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray55x[i]/2.3+300),
                        (250-jsarray55y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray56x[i]/2.3+300),
                        (250-jsarray56y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray57x[i]/2.3+300),
                        (250-jsarray57y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray58x[i]/2.3+300),
                        (250-jsarray58y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray59x[i]/2.3+300),
                        (250-jsarray59y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray60x[i]/2.3+300),
                        (250-jsarray60y[i]/2.2),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray61x[i]/2.3+300),
                        (250-jsarray61y[i]/2.2),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray62x[i]/2.3+300),
                        (250-jsarray62y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray63x[i]/2.3+300),
                        (250-jsarray63y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray64x[i]/2.3+300),
                        (250-jsarray64y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray65x[i]/2.3+300),
                        (250-jsarray65y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray66x[i]/2.3+300),
                        (250-jsarray66y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray67x[i]/2.3+300),
                        (250-jsarray67y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray68x[i]/2.3+300),
                        (250-jsarray68y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray69x[i]/2.3+300),
                        (250-jsarray69y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray70x[i]/2.3+300),
                        (250-jsarray70y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray71x[i]/2.3+300),
                        (250-jsarray71y[i]/2.2),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray72x[i]/2.3+300),
                        (250-jsarray72y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray73x[i]/2.3+300),
                        (250-jsarray73y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray74x[i]/2.3+300),
                        (250-jsarray74y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray75x[i]/2.3+300),
                        (250-jsarray75y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray76x[i]/2.3+300),
                        (250-jsarray76y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray77x[i]/2.3+300),
                        (250-jsarray77y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray78x[i]/2.3+300),
                        (250-jsarray78y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray79x[i]/2.3+300),
                        (250-jsarray79y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray80x[i]/2.3+300),
                        (250-jsarray80y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray81x[i]/2.3+300),
                        (250-jsarray81y[i]/2.2),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray82x[i]/2.3+300),
                        (250-jsarray82y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray83x[i]/2.3+300),
                        (250-jsarray83y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray84x[i]/2.3+300),
                        (250-jsarray84y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray85x[i]/2.3+300),
                        (250-jsarray85y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray86x[i]/2.3+300),
                        (250-jsarray86y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray87x[i]/2.3+300),
                        (250-jsarray87y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray88x[i]/2.3+300),
                        (250-jsarray88y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray89x[i]/2.3+300),
                        (250-jsarray89y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray90x[i]/2.3+300),
                        (250-jsarray90y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray91x[i]/2.3+300),
                        (250-jsarray91y[i]/2.2),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray92x[i]/2.3+300),
                        (250-jsarray92y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray93x[i]/2.3+300),
                        (250-jsarray93y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray94x[i]/2.3+300),
                        (250-jsarray94y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray95x[i]/2.3+300),
                        (250-jsarray95y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray96x[i]/2.3+300),
                        (250-jsarray96y[i]/2.2),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray97x[i]/2.3+300),
                        (250-jsarray97y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray98x[i]/2.3+300),
                        (250-jsarray98y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray99x[i]/2.3+300),
                        (250-jsarray99y[i]/2.2),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray100x[i]/2.3+300),
                        (250-jsarray100y[i]/2.2),
                        0.1
                    ]);
                }
