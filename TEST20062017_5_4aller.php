...
?>
    ...
    <div id="main" style="width:3015px;height:2500px;background-image:url(arg_mairie_plan_13062017_3.jpg);background-repeat:no-repeat"></div>
        ...
        require(
            ...
            function (ec) {
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray1x[i]*3.3+1501),
                        (1250-jsarray1y[i]*3.35),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray2x[i]*3.3+1501),
                        (1250-jsarray2y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray3x[i]*3.3+1501),
                        (1250-jsarray3y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray4x[i]*3.3+1501),
                        (1250-jsarray4y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray5x[i]*3.3+1501),
                        (1250-jsarray5y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray6x[i]*3.3+1501),
                        (1250-jsarray6y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray7x[i]*3.3+1501),
                        (1250-jsarray7y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray8x[i]*3.3+1501),
                        (1250-jsarray8y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray9x[i]*3.3+1501),
                        (1250-jsarray9y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray10x[i]*3.3+1501),
                        (1250-jsarray10y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray11x[i]*3.3+1501),
                        (1250-jsarray11y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray12x[i]*3.3+1501),
                        (1250-jsarray12y[i]*3.35),
                        0.1
                    ]);
                } 
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray13x[i]*3.3+1501),
                        (1250-jsarray13y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray14x[i]*3.3+1501),
                        (1250-jsarray14y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray15x[i]*3.3+1501),
                        (1250-jsarray15y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray16x[i]*3.3+1501),
                        (1250-jsarray16y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray17x[i]*3.3+1501),
                        (1250-jsarray17y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray18x[i]*3.3+1501),
                        (1250-jsarray18y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray19x[i]*3.3+1501),
                        (1250-jsarray19y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray20x[i]*3.3+1501),
                        (1250-jsarray20y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray21x[i]*3.3+1501),
                        (1250-jsarray21y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray22x[i]*3.3+1501),
                        (1250-jsarray22y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray23x[i]*3.3+1501),
                        (1250-jsarray23y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray24x[i]*3.3+1501),
                        (1250-jsarray24y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray25x[i]*3.3+1501),
                        (1250-jsarray25y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray26x[i]*3.3+1501),
                        (1250-jsarray26y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray27x[i]*3.3+1501),
                        (1250-jsarray27y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray28x[i]*3.3+1501),
                        (1250-jsarray28y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray29x[i]*3.3+1501),
                        (1250-jsarray29y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray30x[i]*3.3+1501),
                        (1250-jsarray30y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray31x[i]*3.3+1501),
                        (1250-jsarray31y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray32x[i]*3.3+1501),
                        (1250-jsarray32y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray33x[i]*3.3+1501),
                        (1250-jsarray33y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray34x[i]*3.3+1501),
                        (1250-jsarray34y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray35x[i]*3.3+1501),
                        (1250-jsarray35y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray36x[i]*3.3+1501),
                        (1250-jsarray36y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray37x[i]*3.3+1501),
                        (1250-jsarray37y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray38x[i]*3.3+1501),
                        (1250-jsarray38y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray39x[i]*3.3+1501),
                        (1250-jsarray39y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray40x[i]*3.3+1501),
                        (1250-jsarray40y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray41x[i]*3.3+1501),
                        (1250-jsarray41y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray42x[i]*3.3+1501),
                        (1250-jsarray42y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray43x[i]*3.3+1501),
                        (1250-jsarray43y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray44x[i]*3.3+1501),
                        (1250-jsarray44y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray45x[i]*3.3+1501),
                        (1250-jsarray45y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray46x[i]*3.3+1501),
                        (1250-jsarray46y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray47x[i]*3.3+1501),
                        (1250-jsarray47y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray48x[i]*3.3+1501),
                        (1250-jsarray48y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray49x[i]*3.3+1501),
                        (1250-jsarray49y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray50x[i]*3.3+1501),
                        (1250-jsarray50y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray51x[i]*3.3+1501),
                        (1250-jsarray51y[i]*3.35),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray52x[i]*3.3+1501),
                        (1250-jsarray52y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray53x[i]*3.3+1501),
                        (1250-jsarray53y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray54x[i]*3.3+1501),
                        (1250-jsarray54y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray55x[i]*3.3+1501),
                        (1250-jsarray55y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray56x[i]*3.3+1501),
                        (1250-jsarray56y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray57x[i]*3.3+1501),
                        (1250-jsarray57y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray58x[i]*3.3+1501),
                        (1250-jsarray58y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray59x[i]*3.3+1501),
                        (1250-jsarray59y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray60x[i]*3.3+1501),
                        (1250-jsarray60y[i]*3.35),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray61x[i]*3.3+1501),
                        (1250-jsarray61y[i]*3.35),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray62x[i]*3.3+1501),
                        (1250-jsarray62y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray63x[i]*3.3+1501),
                        (1250-jsarray63y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray64x[i]*3.3+1501),
                        (1250-jsarray64y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray65x[i]*3.3+1501),
                        (1250-jsarray65y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray66x[i]*3.3+1501),
                        (1250-jsarray66y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray67x[i]*3.3+1501),
                        (1250-jsarray67y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray68x[i]*3.3+1501),
                        (1250-jsarray68y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray69x[i]*3.3+1501),
                        (1250-jsarray69y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray70x[i]*3.3+1501),
                        (1250-jsarray70y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray71x[i]*3.3+1501),
                        (1250-jsarray71y[i]*3.35),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray72x[i]*3.3+1501),
                        (1250-jsarray72y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray73x[i]*3.3+1501),
                        (1250-jsarray73y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray74x[i]*3.3+1501),
                        (1250-jsarray74y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray75x[i]*3.3+1501),
                        (1250-jsarray75y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray76x[i]*3.3+1501),
                        (1250-jsarray76y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray77x[i]*3.3+1501),
                        (1250-jsarray77y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray78x[i]*3.3+1501),
                        (1250-jsarray78y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray79x[i]*3.3+1501),
                        (1250-jsarray79y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray80x[i]*3.3+1501),
                        (1250-jsarray80y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray81x[i]*3.3+1501),
                        (1250-jsarray81y[i]*3.35),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray82x[i]*3.3+1501),
                        (1250-jsarray82y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray83x[i]*3.3+1501),
                        (1250-jsarray83y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray84x[i]*3.3+1501),
                        (1250-jsarray84y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray85x[i]*3.3+1501),
                        (1250-jsarray85y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray86x[i]*3.3+1501),
                        (1250-jsarray86y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray87x[i]*3.3+1501),
                        (1250-jsarray87y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray88x[i]*3.3+1501),
                        (1250-jsarray88y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray89x[i]*3.3+1501),
                        (1250-jsarray89y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray90x[i]*3.3+1501),
                        (1250-jsarray90y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray91x[i]*3.3+1501),
                        (1250-jsarray91y[i]*3.35),
                        0.1
                    ]);
                }
                ...
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray92x[i]*3.3+1501),
                        (1250-jsarray92y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray93x[i]*3.3+1501),
                        (1250-jsarray93y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray94x[i]*3.3+1501),
                        (1250-jsarray94y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray95x[i]*3.3+1501),
                        (1250-jsarray95y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray96x[i]*3.3+1501),
                        (1250-jsarray96y[i]*3.35),
                        0.1
                    ]);
                }
                for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray97x[i]*3.3+1501),
                        (1250-jsarray97y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray98x[i]*3.3+1501),
                        (1250-jsarray98y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray99x[i]*3.3+1501),
                        (1250-jsarray99y[i]*3.35),
                        0.1
                    ]);
                }
                 for (var i = 0; i < <?php echo json_encode($i);?>; i++) {
                    heatData.push([
                        (jsarray100x[i]*3.3+1501),
                        (1250-jsarray100y[i]*3.35),
                        0.1
                    ]);
                }
